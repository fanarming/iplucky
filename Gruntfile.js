module.exports = function(grunt) {
    ...
    // 发布任务
    grunt.registerTask('release', ['sass', 'clean:build', 'copy:release', 'sprite', 'cssmin', 'uglify', 'ejs_static:release','concat:trans_css','concat:trans_html','clean:release','connect:site_dest']);
